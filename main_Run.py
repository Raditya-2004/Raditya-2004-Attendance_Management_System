...
def manually_fill():
    ...
    def fill_attendance():
        ...
        DB_table_name = f"{subb.replace(' ', '')}{Date}Time{Hour}{Minute}{Second}"
        ...
        MFW.configure(background='#4B0082')
...
def err_screen():
    ...
    sc1.title('Warning!!')
    sc1.configure(background='#4B0082')
...
def err_screen1():
    ...
    sc2.title('Warning!!')
    sc2.configure(background='#4B0082')
...
def subjectchoose():
    ...
    windo.configure(background='#4B0082')
...
message = tk.Label(window, text="Attendance Management System using Face Recognition", bg="red", fg="black", width=50,
